...
<body>
<script src="resources/js/traderdiary.common.js" defer></script>
<script src="resources/js/traderdiary.users.js" defer></script>
  ...
  <div class="container">
    ...
    <table class="table table-striped" id="datatable">
      ...
      <c:forEach items="${requestScope.users}" var="user">
        <jsp:useBean id="user" type="com.grigorievfinance.traderdiary.model.User"/>
        <tr>
